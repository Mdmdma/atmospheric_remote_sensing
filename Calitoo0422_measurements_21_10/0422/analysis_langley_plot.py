...
# import data
df = pd.read_csv(r"C:\Users\Nathalie\Documents\GitHub\atmospheric_remote_sensing\Calitoo0422_measurements_21_10\data_for_analysis_py_script\0422_data.txt", delimiter=';')
#%%
...
#%% Langley Plot
df_day = df[df['Date']=='2024-10-21']

df_day['sza_rad'] = np.deg2rad(90-df_day['Elevation'])
df_day['air_mass'] = 1 / np.cos(df_day['sza_rad'])
...
# Plot for RAW465
calibration_constant_465 = plot_langley(df_day, 'RAW465', 'blue', '465nm')

# Plot for RAW540
calibration_constant_540 = plot_langley(df_day, 'RAW540', 'green', '540nm')

# Plot for RAW619
calibration_constant_619 = plot_langley(df_day, 'RAW619', 'red', '619nm')
